...
/*
 * delete stock_management stock servlet
 */
/**
...
public class deletestockservlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue=addtaskDButil.deletestock(stockno, itemname, itemdescr, unit, rate, quantity, amount);
		
		if(isTrue==true){
			
			RequestDispatcher dis = request.getRequestDispatcher("successDelete.jsp");
