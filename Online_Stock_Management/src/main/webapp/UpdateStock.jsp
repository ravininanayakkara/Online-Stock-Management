...
<title>Confirm Stock Update | Online Stock Management System</title>
</head>

<body>
<h1 style="position: relative;color: #fff;">Update Stock Details</h1>
...
<!-- set want update data to a form -->
...
<input type ="submit" name="submit" value="Update Stock Data">
